...
export const TRANSLATIONS: TranslationMap = {
  ...
  filter_all: { en: 'All Offerings (73)', ml: 'എല്ലാ വഴിപാടുകളും (73)' },
  ...
  search_offerings_placeholder: { en: 'Search 73 offerings by name or benefit (e.g. Dhara, Homam, വിവാഹം)...', ml: '73 വഴിപാടുകളിൽ തിരയുക (ഉദാ: ധാര, ഹോമം, പായസം)...' },
