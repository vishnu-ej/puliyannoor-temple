...
export const TRANSLATIONS: TranslationMap = {
  ...
  filter_all: { en: 'All Offerings', ml: 'എല്ലാം' },
  filter_daily: { en: 'Daily Sevas', ml: 'നിത്യപൂജകൾ' },
  filter_homam: { en: 'Homams', ml: 'ഹോമങ്ങൾ' },
  filter_archana: { en: 'Archanas', ml: 'അർച്ചനകൾ' },
  filter_nivedyam: { en: 'Nivedyams', ml: 'നിവേദ്യങ്ങൾ' },
  filter_special: { en: 'Special Poojas', ml: 'വിശേഷാൽ പൂജകൾ' },
  search_offerings_placeholder: { en: 'Search offering by name or intention...', ml: 'വഴിപാടിന്റെ പേര് തിരയുക...' },
