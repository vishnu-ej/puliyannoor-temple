...
export const TRANSLATIONS: TranslationMap = {
  ...
  timings_subtitle: {
    en: 'The temple observes the traditional two-session darshan schedule (Morning 4:00 AM – 10:00 AM & Evening 5:30 PM – 7:00 PM). The morning opening is at 4:00 AM.',
    ml: 'കേരളത്തിലെ ശിവക്ഷേത്രങ്ങളിലെ പാരമ്പര്യമനുസരിച്ച് ദിവസേന രണ്ടു സമയങ്ങളിലാണ് ദർശനം ക്രമീകരിച്ചിരിക്കുന്നത് (രാവിലെ 4:00 – 10:00 & വൈകിട്ട് 5:30 – 7:00). പുലർച്ചെ 4:00 മണിക്ക് നടതുറപ്പ്.',
  },
  ...
  session_morning_hours: { en: '4:00 AM – 10:00 AM', ml: 'രാവിലെ 4:00 – 10:00' },
  session_evening_hours: { en: '5:30 PM – 7:00 PM', ml: 'വൈകിട്ട് 5:30 – രാത്രി 7:00' },
  timings_disclaimer: {
  ...
  // Booking Modal
  modal_title: { en: 'Offering Booking & Inquiry', ml: 'വഴിപാട് ബുക്കിംഗും വിവരങ്ങളും' },
  modal_subtitle: {
  ...
  modal_devotee_name_placeholder: { en: 'e.g., Suresh Kumar / സുരേഷ് കുമാർ', ml: 'ഉദാ: സുരേഷ് കുമാർ' },
  modal_star: { en: 'Birth Star (Nakshatra)', ml: 'ജന്മ നക്ഷത്രം' },
  modal_select_star: { en: '-- Select Birth Star / നക്ഷത്രം തിരഞ്ഞെടുക്കുക --', ml: '-- നക്ഷത്രം തിരഞ്ഞെടുക്കുക --' },
  modal_date: { en: 'Preferred Date of Offering', ml: 'വഴിപാട് നടത്തേണ്ട തീയതി' },
  modal_phone: { en: 'Contact Phone / WhatsApp', ml: 'ഫോൺ / വാട്സാപ്പ് നമ്പർ' },
  modal_phone_placeholder: { en: '10-digit mobile number', ml: '10 അക്ക മൊബൈൽ നമ്പർ' },
  modal_selected_offering: { en: 'Selected Offering', ml: 'തിരഞ്ഞെടുത്ത വഴിപാട്' },
  modal_special_notes: { en: 'Special Prayer / Sankalpam', ml: 'പ്രാർത്ഥന / സങ്കൽപ്പം' },
  modal_special_notes_placeholder: { en: 'e.g., For health, family prosperity, birthday, anniversary...', ml: 'ഉദാ: ദീർഘായുസ്സ്, കുടുംബൈശ്വര്യം, പിറന്നാൾ, വിവാഹ വാർഷികം...' },
  modal_family_name: { en: 'Family / Illam Name', ml: 'കുടുംബപ്പേര് / ഇല്ലപ്പേര്' },
  modal_place: { en: 'Place / Residence', ml: 'സ്ഥലം / വിലാസം' },
  modal_select_offering: { en: 'Choose Offering', ml: 'വഴിപാട് തിരഞ്ഞെടുക്കുക' },
  modal_offering_rate: { en: 'Offering Rate', ml: 'വഴിപാട് നിരക്ക്' },
  modal_quantity: { en: 'Quantity', ml: 'എണ്ണം' },
  modal_btn_whatsapp: { en: 'Inquire via WhatsApp', ml: 'വാട്സാപ്പ് വഴി അന്വേഷിക്കുക' },
  modal_btn_submit: { en: 'Book Offering (Add to Cart)', ml: 'വഴിപാട് ബുക്ക് ചെയ്യുക' },
  modal_close: { en: 'Close', ml: 'അടയ്ക്കുക' },

  // Compatibility aliases
  form_star: { en: 'Birth Star (Nakshatra)', ml: 'ജന്മ നക്ഷത്രം' },
  form_select_star: { en: '-- Select Birth Star / നക്ഷത്രം തിരഞ്ഞെടുക്കുക --', ml: '-- നക്ഷത്രം തിരഞ്ഞെടുക്കുക --' },
  form_date: { en: 'Preferred Date', ml: 'വഴിപാട് തീയതി' },
  lbl_family_name: { en: 'Family / Illam Name', ml: 'കുടുംബപ്പേര് / ഇല്ലപ്പേര്' },
  lbl_place: { en: 'Place / Residence', ml: 'സ്ഥലം / വിലാസം' },
  lbl_special_prayer: { en: 'Special Prayer / Sankalpam', ml: 'പ്രാർത്ഥന / സങ്കൽപ്പം' },
  btn_add_to_cart: { en: 'Book Offering (Add to Cart)', ml: 'വഴിപാട് ബുക്ക് ചെയ്യുക' },
  btn_inquire_whatsapp: { en: 'Inquire via WhatsApp', ml: 'വാട്സാപ്പ് വഴി അന്വേഷിക്കുക' },
  ...
  contact_hours_desc: { en: '4:00 AM – 10:00 AM & 5:30 PM – 7:00 PM', ml: 'രാവിലെ 4:00 – 10:00 & വൈകിട്ട് 5:30 – 7:00' },
